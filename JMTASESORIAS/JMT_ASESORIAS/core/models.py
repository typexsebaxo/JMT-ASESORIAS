...
class admin(models.Model):
    id_admin = models.IntegerField(("11"))
    ...
    telefono_admin = models.IntegerField(("11"))
    ciudad_nombre_ciudad = models.TextField(max_length = 50)
    usuario_id_usuario = models.IntegerField(("11"))
...
class  ciudad(models.Model):
    ...
    region_numero_region = models.IntegerField(("11"))
...
class permisos(models.Model):
    id_permisos = models.IntegerField(("11"))
...
class region(models.Model):
    numero_region = models.IntegerField(("11"))
    nombre_region = models.TextField(max_length = 50)

class resumen(models.Model):
    id_resumen = models.IntegerField(("11"))
...
class tasacion(models.Model):
    id_tasacion = models.IntegerField(("11"))
